...
#Originally wrote this for Dreamscape, however re-used bits for Runecessor.
...
def chat_7634714(player):
    player.getDH().sendNpcChat("Why are you surprised? This is Runecessor not" , "real life, anything is possible.", 591)
...
def chat_73743(player):
    player.getDH().sendNpcChat("Snow piles form at various locations around Runecessor" , "every 4 hours or so, type in ::events to see when it starts!", 591) 
