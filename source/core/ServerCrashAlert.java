 ...
 *
 * @author Lava, created on 13-08-2017
 */
public class ServerCrashAlert {
	...
	public static TimerTask websiteOnlineTask = new TimerTask() {
		...
		public void run() {
			...
			String websiteStatus = websiteOnline("http://Runecessor.com", "<li><a href=\"https://www.facebook.com/runecessor.rsps\">Facebook</a></li>") + " ";
			total = websiteStatus;
			websitesAmount++;
	...
	public static TimerTask tradingPostTask = new TimerTask() {
		...
		public void run() {
			...
			if (amountInvested < TOKENS_AMOUNT_INVESTED) {
				...
				EmailSystem.addPendingEmail("Trading post at: " + Misc.formatNumber(amountInvested) + " Donator tokens being purchased", content, "");
			}
