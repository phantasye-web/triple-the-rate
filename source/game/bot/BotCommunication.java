 ...
 *
 * @author Lava, created on 21-04-2016.
 */
public class BotCommunication {

	//@formatter:off
	private final static String[] GOOD_LUCK = {"Good luck", "Gl", "even as a bot im better than u", "Greetings.", "Gl bro", "Gl m8", "Gl no safe", "Gl bro", "Lets go" , "suk my dick"};
	...
	private final static String[] BOT = {"Yes.", "I sure am", "Yes, please don't abuse me", "Wag1", "1v1 me", "Ye, fight me?", "Lava created me",
