 ...
 * @author Lava, created on 17-05-2018
 */
public class XpBonus {
	...
	public static final int NEW_PLAYER_XP_BONUS_MINUTES = 30;
	public static final int SMALL_LAMP = 10;
	public static final int MED_LAMP = 25;
	public static final int LARGE_LAMP = 60;
	public static final int HUGE_LAMP = 1440;
