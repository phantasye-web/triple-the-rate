...
public class PlayerRank {
	...
	public static boolean isDeveloper(Player player) {
		if (player.getPlayerName().equals("Owner") || player.getPlayerName().equals("Owain") && ServerConfiguration.DEBUG_MODE
		    || player.getPlayerName().equals("Owner") && ServerConfiguration.DEBUG_MODE) {
			return true;
		}
		return false;
	}
