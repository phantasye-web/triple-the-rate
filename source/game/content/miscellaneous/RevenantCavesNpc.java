...
public class RevenantCavesNpc {
	...
	private final static int PLAYER_FROZEN_AMOUNT_SECONDS = 40;

	private final static int PLAYER_CAN_BE_ATTACKED_X_SECONDS_BEFORE_UNFROZEN = 10;

	public static enum StatuetteData {
		MEMBLEM(12746, 50_000),
		
		EMBLEM(21807, 500_000),
		
		TOTEM(21810, 1000_000),
		STATUETTE(21813, 2000_000),
		MEDALLION(22299, 4000_000),
		EFFIGY(22302, 8000_000),
		RELIC(22305, 15000_000);
			...
			public void execute(CycleEventContainer container) {
				switch (container.getExecutions()) {
					...
					case 1:
						...
						player.gfx0(369);
						player.frozenBy = -1;
						DamageQueue.add(new Damage(player, npc, ServerConstants.MAGIC_ICON, 1, 45, Misc.random(15, 25)));
						break;
