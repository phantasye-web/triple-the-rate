 ...
 *
 * @author Lava, created on 02-01-2015.
 */
public class FightCaves {
	...
	private static void fightCavesReward(Player player) {
		if(Misc.hasOneOutOf(200)) {
			ItemAssistant.addItemToInventoryOrDrop(player, 22315, 1);
			player.getPA().announce(" " +player.getPlayerName()+" received Infernal Stone from jad try your best");
		}
