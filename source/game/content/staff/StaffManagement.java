 ...
 *
 * @author Lava, created on 18-10-2017.
 */
public class StaffManagement {

	/**
	 * Store the player's name, followed by the rights he should be changed to.
	 * Lava-1 means Lava will get Moderator when he logs on.
	...
	public static void changePlayerRank(Player player, String command) {
		...
		try {
			...
			player.getPA().sendMessage("Use as ::rank support Lava");
		}
	}
