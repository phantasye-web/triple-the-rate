 ...
 * Thieving stalls.
 *
 * @author Lava, created on 29-11-2015.
 */
public class Stalls {
	...
	/*	BANANA_STALL(1, 20, 2313, 6163, 1),
		GENERAL_STALL(30, 40, 3224, 6165, 2),
		CRAFTING_STALL(50, 80, 1741, 6166, 3),
		RUNES_STALL(65, 111, 9594, 6164, 4),
		SCIMITAR_STALL(85, 222, 1617, 6162, 5);*/
...
/*BANANA_STALL(1, 20, 1963, 4875, 2),
		...
		SCIMITAR_STALL(85, 160, 6721, 4878, 7);*/
		BANANA(1963, 2000),
		GOLDEN_TINDERBOX(2946, 4000),
		CRUSHED_GEM(1633, 6000),
		GROUND_MUD_RUNE(9594, 9000),
		RUSTY_SCIMITAR(6721, 12000);
