 ...
 *
 * @author Lava, created on 29-07-2015.
 */
public class WildernessCourse {
	...
	private static void doorEntrance(Player player) {
		if (player.baseSkillLevel[ServerConstants.AGILITY] < 52) {
			player.playerAssistant.sendMessage("52 agility is required to use this course.");
