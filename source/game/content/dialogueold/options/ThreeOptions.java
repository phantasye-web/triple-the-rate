...
public class ThreeOptions {
	...
	public static void firstOption(Player player) {
		...
		switch (player.getDialogueAction()) {
			...
			case 459:
				...
				player.getPA().openWebsite("www.Runecessor.com/forum/topic/575-clue-scroll-rewards-100-new-items-31-05-2017", true);
				break;
	...
	public static void secondOption(Player player) {
		...
		switch (player.getDialogueAction()) {
			...
			case 459:
				...
				player.getPA().openWebsite("www.Runecessor.com/forum/topic/679-new-clue-casket-second-release-donator-pking-loot-buff-more-16-06-2017", true);
				break;
	...
	public static void thirdOption(Player player) {
		...
		switch (player.getDialogueAction()) {
			...
			// Twiggy, Open www.Runecessor.com/event
			case 260:
				//player.getPA().sendMessage("click 'Home' on client links above to open the website.");
				player.getPA().openWebsite("Runecessor.com/vote", true);
				break;
			...
			// Donator assistant, Custom Donator Pet store
			case 668:
			///	player.getPA().sendMessage("click 'Store' on client links above to open the donation page.");
				player.getDH().sendStatement("If you want to donate please pm Michael ingame or on Discord / Forum!");
				break;
