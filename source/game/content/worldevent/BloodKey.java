...
public class BloodKey {
	...
	private final static int SECONDS_TO_PICK_UP_KEY = 2;
	...
	public static void spawnBloodKey(String type) {
		...
		if (type.equals("KEY")) {
			...
			string = "Kill Skotizo for 5-15m loot!";
		}
	...
	public static void pickUpBloodKey(Player player, int itemId) {
		/*if (player.getCombatLevel() != 3) {
			player.getPA().sendMessage("Sneaky sneaky, level 3 or no can do.");
			return;
		}*/
	...
	public static void openChest(Player player, int itemId) {
		...
		if (reward > 0) {
			Announcement.announce(
					player.getPlayerName() + " has received " + Misc.formatRunescapeStyle(amount) + " gp and a " + ItemAssistant.getItemName(reward) + " from the " + ItemAssistant
							                                                                                                                                                  .getItemName(
									                                                                                                                                                  itemId)
