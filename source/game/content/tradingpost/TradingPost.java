 ...
 *
 * @author Lava, created on 20-07-2017.
 */
public class TradingPost {


	public static String getAverageTokenPrice() {
		return GameType.isOsrsEco() ? "4k" : "1.5m";
	}
	...
	private static void showAveragePrice(Player player) {
		player.getPA().sendFrame126("Donator tokens trading post: (avrg x" + "2M Coins" + " )", 28952);
	...
	public static void updateHistory(Player player) {
		//28992
		//Sold x10 Donator token for 2,000 each to: Lava.
