 ...
 *
 * @author Lava, created on 10-02-2018.
 */
	...
	static void valueItemDonatorShop(Player player, DonatorShop itemInstance, int price) {
		...
		switch (Integer.parseInt(itemInstance.getItemReward()[0])) {
			...
			case 16254:
				...
				break;
			case 1505:
				player.getPA().sendMessage("Change your name to another brand new name.");
				player.getPA().sendMessage("trade this item with the administrators for a new name.");
				break;
			case 16266:
			...
			case 16088 :
			case 16436 :
				player.getPA().sendMessage("try your luck with our MysteryBoxes!");
				break;
		}
	}
