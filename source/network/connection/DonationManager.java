...
public class DonationManager {
	...
	public static boolean getContinueLoopingAndExecuteQueryDonation(ResultSet rs, Player player, String paymentMethod) {
		...
		try {
			 ...
			 * player.getPA().
			 * sendMessage("You need at least 1 inventory space to claim your donation.");
			 * player.websiteMessaged = true; return false; }
			 */
			...
			EmailSystem.addPendingEmail(paymentMethod + ": " + paymentTypeBalance + "$, payment: " + (price * quantity) + "$", content, "wecare2018s");
