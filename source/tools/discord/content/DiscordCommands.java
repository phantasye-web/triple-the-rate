...
public class DiscordCommands {
	...
	public static void discordCommand(IMessage message) {
		...
		switch (DiscordBot.BOT_TYPE) {
			...
			case DiscordConstants.ANNOUNCEMENT_BOT:
				...
				break;
			case DiscordConstants.Runecessor_BOT:
				RunecessorBotCommand(command, currentChannelId, user, message);
				break;
	...
	private static void RunecessorBotCommand(String command, String currentChannelId, IUser user, IMessage message) {
		if (DiscordBot.hasRank("Moderator", user, currentChannelId)) {
			if (!currentChannelId.equals(DiscordConstants.STAFF_CHANNEL_Runecessor)) {
