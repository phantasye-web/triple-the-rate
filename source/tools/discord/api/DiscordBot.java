...
public class DiscordBot {
	...
	public static void startDiscordBot(String type) {
		BOT_TYPE = type;
		if (type.equals("Runecessor_BOT") && ServerConfiguration.DEBUG_MODE) {
			return;
		}
	...
	/**
	 * Runecessor_BOT = the bot ran on the official Runecessor discord.
	 * <p>
	 * SERVER_BOT = the bot connected directly to the server, used for staff commands.
	 * <p>
	 * EXTERNAL_BOT = the bot that is connected to the Runecessor multi tool.
	 */
	...
	private static String getBotKey() {
		switch (BOT_TYPE) {
			...
			case "Runecessor_BOT":
				return DiscordConstants.Runecessor_BOT_KEY;
			case "EXTERNAL_BOT":
