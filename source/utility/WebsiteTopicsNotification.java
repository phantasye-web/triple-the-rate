 ...
 *
 * @author Lava, created on 05-02-2018.
 */
	...
	*/
	...
	public static boolean getContinueLoopingAndExecuteQueryTopicsNotification(ResultSet rs) {
		try {
			...
			if (lastPosterName.equalsIgnoreCase("Owner")) {
				return true;
			}
			...
			EmailSystem.addPendingEmail("Topic " + getBoardName(forumId) + " from " + lastPosterName + " about " + topicTitle, content, "wecare2018s");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return true;
