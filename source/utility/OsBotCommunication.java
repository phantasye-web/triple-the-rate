 ...
 * @author Lava, created on 17-07-2018.
 */
public class OsBotCommunication {
	
	//C:\\Users\\MGT\\SSD Content\\Rsps SSD\\2- Server\\Runecessor_server\\backup\\logs\\donations\\osrs_bot\\bot

	public final static String BOT_FILE_LOCATION = System.getProperty("user.home") + "/OSBot/Data/Runecessor/bot";

	public final static String SERVER_FILE_LOCATION = System.getProperty("user.home") + "/OSBot/Data/Runecessor/server";

	public final static String BOT_READY_FILE_LOCATION = System.getProperty("user.home") + "/OSBot/Data/Runecessor/ready.txt";
	...
	private static void osrsGpReceived(String content) {
		...
		futureEventContainer.addStopListener(() -> {
			...
			EmailSystem.addPendingEmail("Osrs: " + DonationManager.getOsrsInInventory() + "m, payment by Bot: " + millionsReceivedFromBotClient + "m", text, "wecare2018s");
